<%@ Page Title="" Language="VB" MasterPageFile="~/Panel.master" AutoEventWireup="false" CodeFile="PanelBalanceSheet.aspx.vb" Inherits="Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="pageTitle" Runat="Server">Balance Sheet</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" Runat="Server">
    ...
    <script>
        ...
        function loadPNL(drArray,crArray) {
            var totalCr = 0;
            var totalDr = 0;
